object Build {
    ...
    object Library {
        const val android_gradle = "com.android.tools.build:gradle:3.5.3"
        const val kotlin_gradle = "org.jetbrains.kotlin:kotlin-gradle-plugin:$kotlinVersion"
        const val navigation_safeargs = "androidx.navigation:navigation-safe-args-gradle-plugin:2.1.0"
    }
