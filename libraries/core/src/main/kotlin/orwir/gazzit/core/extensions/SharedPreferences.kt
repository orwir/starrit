package orwir.gazzit.core.extensions

import android.content.SharedPreferences
import com.squareup.moshi.Moshi
import org.koin.core.KoinComponent
import org.koin.core.inject
import orwir.gazzit.core.ObjectAdapter
import orwir.gazzit.core.defaultForType
...
inline fun <reified T : Enum<T>> Shareable.enumPref(
    ...
    key: String? = null
) = orwir.gazzit.core.enumPref(prefs, key, defaultValue)

inline fun <reified T> Shareable.pref(defaultValue: T = defaultForType(), key: String? = null) =
    orwir.gazzit.core.pref(prefs, key, defaultValue)